...
# Версия программы из Git
function(getProgramVersion version date)
    if (GIT_EXECUTABLE)
...
function(getFileVersion file_name version)
    file(READ ${VERSION_FILE} str)
    string(REGEX MATCH "[0-9]+\.[0-9]+\.[0-9]+(-[0-9+]+)?" VERSION_IN_FILE ${str})
    if (${CMAKE_MATCH_0})
        set(VERSION_IN_FILE "0.0.0-0")
    endif()

    set(${version} ${VERSION_IN_FILE} PARENT_SCOPE)
endfunction()

# Записать версию в файл version.inc
