...
Этот проект был создан для обучения моего сына программированию и поддержания моих профессиональных навыков, 
а также из-за наличия небольшого количества свободного времени.
...
В версии 0.4 логика управления игрой перенесена в конечный автомат QStateMachine.
